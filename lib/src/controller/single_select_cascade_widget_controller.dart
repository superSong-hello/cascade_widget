...
class SingleSelectCascadeWidgetController extends ChangeNotifier {
  ...
  void checkAllItemState(
    ...
    if (!isFromChipClick) {
      ...
      if (isSelected) {
        currentClickItem.isSelected = false;
      } else {
        _getSelectedList(list, []).forEach((e) {
          e.isSelected = false;
        });
        selectedList.clear();
        currentClickItem.isSelected = true;
      }
      ...
      selectedList.clear();
      currentClickItem.isSelected = selected;
