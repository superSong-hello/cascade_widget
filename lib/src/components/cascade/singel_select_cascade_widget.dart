...
class _SingleSelectCascadeWidgetState extends State<SingleSelectCascadeWidget>
  ...
  void initState() {
    ...
    if (widget.controller == null) {
      _cascadeController = SingleSelectCascadeWidgetController();
  ...
  @override
  void didUpdateWidget(covariant SingleSelectCascadeWidget oldWidget) {
        ...
        child: Row(
          ...
          children: [
            ConstrainedBox(
              ...
              child: CustomText(
                chipDecoration.isShowFullPathFromSelectedTag
                    ? info.pathName
                    : info.name,
